...
const { generateProductDescription } = require("../services/aiServices");
const { generateProductDetailsFromImage } = require("../services/aiServices");
...
const createProduct = async (req, res) => {
  try {
    ...
    //code to insert this product into pinecone for semantic search can be added 

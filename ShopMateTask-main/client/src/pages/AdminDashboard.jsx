...
import { Trash2, Edit, Plus, X, Save,Camera } from 'lucide-react';
...
const AdminDashboard = () => {
    ...
    const generateDescription = async () => {
        if (!formData.name && !formData.category) {
            alert('Please enter the product name and category first.');
            return;
        }
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            <div className="flex justify-between items-center mb-1">
                                                ...
                                                {imageFile && (
                                                    <button type="button" onClick={generateDetailsFromImage} disabled={isGeneratingFromImage} className="text-xs text-indigo-600 hover:text-indigo-800 flex items-center gap-1 disabled:opacity-50">
                                                        <Camera size={14}/>
                                                        {isGeneratingFromImage ? 'Analyzing...' : 'Snap & Sell'}
                                                    </button>
                                                )}
                                            </div>
                                            <input type="file" accept="image/*" onChange={handleImageChange} className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-black focus:border-black sm:text-sm"/>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <button
                                                ...
                                                disabled={isGeneratedDescription}>
                                                {isGeneratedDescription ? 'Generating...' : 'Generate with AI'}
                                                </button>
                                        </div>
                                            <textarea
                                                required
